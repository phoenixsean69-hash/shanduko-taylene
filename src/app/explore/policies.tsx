    ...
    <SafeAreaView style={styles.safe}>
      <ScrollView contentContainerStyle={styles.container}>
        ...
        <View style={styles.card}>
          <Text style={styles.cardTitle}>Membership Bylaws</Text>
          <Text style={styles.cardText}>
            The cooperative bylaws outline membership criteria, voting rights and responsibilities.
          </Text>
        </View>

        <View style={styles.card}>
          <Text style={styles.cardTitle}>Maintenance Policy</Text>
          <Text style={styles.cardText}>
            Information about shared maintenance responsibilities and reporting issues.
          </Text>
        </View>
      </ScrollView>
    </SafeAreaView>
